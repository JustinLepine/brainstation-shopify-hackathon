...
<>
    <section className="home">
      ...
      <div className="home__right">
        ...
        <p>
          Welcome to Plaza. A new way to shop for anything from camping gear to
          cat clothes at businesses you'll love.
        </p>
        <div className="home__search-section">
          <div className="home__hero-search">
            <img className="home__search-icon" src={SearchIcon} alt="icon" />
            <input
        ...
        <div className="home__filters">            
            <img className="home__filter-icon" src={FilterDropdown} alt="filter dropdown" />
        </div>
      </div>
    </section>
